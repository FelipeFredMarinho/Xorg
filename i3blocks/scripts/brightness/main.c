...
main(int argc, char *argv[]) {
  ...
  static const char *default_abp = "/sys/class/backlight/acpi_video0/actual_brightness";
  static const char *default_mbp = "/sys/class/backlight/acpi_video0/max_brightness";
